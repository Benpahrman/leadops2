    ...
    def get_pipeline_kanban(self) -> dict[str, Any]:
        ...
        for lead in unique_leads:
            ...
            entry = {
                ...
                "state_code": getattr(lead, "state_code", "") or "",
                "county": getattr(lead, "county", "") or "",
                "county_fips": getattr(lead, "county_fips", "") or "",
                "outreach_touch_count": getattr(lead, "outreach_touch_count", 0) or 0,
                "last_outreach_at": getattr(lead, "last_outreach_at", "") or "",
                "next_outreach_at": getattr(lead, "next_outreach_at", "") or "",
                "outreach_replied": getattr(lead, "outreach_replied", False) or False,
                "outreach_thread_id": getattr(lead, "outreach_thread_id", "") or "",
