...
const features = [
  ...
  },
  {
    ...
    title: '$99 Setup Sprint (100% Credited to Month 1)',
    text: 'Deploy your bespoke extraction pipeline with a $99 setup sprint deposit that is 100% credited toward Month 1. Balance activates only after 25 live rows pass >=95% QA verification. Includes 3-Day Free Trial preview.',
  },
  {
    iconSvg: (
